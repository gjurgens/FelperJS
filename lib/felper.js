(function() {    
    ...
    function dispatchCommands(commandLine, menu, commandHistory) {
        ...
        prompt(menu, commandHistory);
    }

    
    function prompt(menu, commandHistory) {
    	...
    	process.stdin.on('data', function(char) {
    		if (char == '\3') {
    			...
    			dispatchCommands(cmdBuffer, menu, commandHistory);
    		} else if (char == '\t') {
